...
OBOBOB 6. Take advantage of template literals
...
OBOBOB        ', with a per capita personal income of ' + budget.income + '. As of 2015, San Francisco' \
